...
import { getFuelHistoryById } from 'apiSdk/fuel-histories';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Fuel History Detail View
          </Text>
          {hasAccess('fuel_history', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/fuel-histories/edit/${data?.id}`} passHref legacyBehavior>
              <Button
